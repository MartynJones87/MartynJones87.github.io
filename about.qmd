...
about:
  ...
  links:
    - icon: github
      text: Github
      href: https://github.com/MartynJones87
    - icon: mastodon
      text: mastodon
      href: https://mastodonapp.uk/@thurboman
    - icon: twitter
      text: Twitter
      href: https://twitter.com/thurboman
    - icon: linkedin
      text: LinkedIn
      href: https://linkedin.com/in/martyn-jones-dev
    - icon: stack-overflow
      text: stackoverflow
      href: https://stackoverflow.com/users/403424/martynjones87

---

Hi, my name is Martyn. I am currently a Computer Science Technical Lead in the [Repair Analytics and Data](https://www.jdpower.com/business/we-predict) department at J.D. Power.
